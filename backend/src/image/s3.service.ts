...
export class S3Service {
  ...
  constructor() {
    ...
    this.logger.log(`S3Service initialized region=${region} bucket=${this.bucket ? 'configured' : 'not-configured'}`);
  }
  ...
  async getPresignedPutUrl(key: string, contentType: string, expiresSeconds = 900) {
